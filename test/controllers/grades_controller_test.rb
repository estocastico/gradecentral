...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { comment: @grade.comment, course: @grade.course, letter_grade: @grade.letter_grade, user_id: @grade.user_id }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { comment: @grade.comment, course: @grade.course, letter_grade: @grade.letter_grade, user_id: @grade.user_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
